 ...
 * @brief 
 * 
 * @param uptime_path if NULL, macro UPTIME_FILE is being used
 * @param uptime_secs will be updated by uptime
 * @param idle_secs will be updated by uptime
 * @return int the updated value of uptime_secs
 */
