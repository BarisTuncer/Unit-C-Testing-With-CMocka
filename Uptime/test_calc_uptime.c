 ...
 *
 * It is a re-implementation of the uptime() function you can find in
 * proc_uptime.c.
 *
 * This function can be instrumented by the test. We can tell it what
                  ...
                  double *idle_secs)
{
    ...
    up = mock_type(double);     /* will be set by will_return */
    idle = mock_type(double);   /* will be set by will_return, so we will need to call will_return twice during mocking! */
